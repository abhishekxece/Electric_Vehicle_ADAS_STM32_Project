...
int main(void)
{
  ...
  while (1)
  {
      ...
      front_dist = read_distance(GPIOB, GPIO_PIN_0,
                                 GPIOB, GPIO_PIN_1);

      left_dist = read_distance(GPIOB, GPIO_PIN_10,
                                GPIOB, GPIO_PIN_11);

      right_dist = read_distance(GPIOB, GPIO_PIN_12,
                                 GPIOB, GPIO_PIN_13);
      ...
      if(front_dist < 15)
      {
          ...
          sprintf(msg,
          "FRONT:%d cm LEFT:%d cm RIGHT:%d cm STATUS:DANGER\r\n",
          (int)front_dist,
          (int)left_dist,
          (int)right_dist);
      }
      ...
      /* BOTH SIDE WARNING */
      else if(left_dist < 20 && right_dist < 20)
      {
          HAL_GPIO_WritePin(GPIOA, GPIO_PIN_1, GPIO_PIN_SET);

          sprintf(msg,
          "FRONT:%d cm LEFT:%d cm RIGHT:%d cm STATUS:BLIND SPOT BOTH\r\n",
          (int)front_dist,
          (int)left_dist,
          (int)right_dist);
      }
      ...
      else if(left_dist < 20)
      {
          ...
          sprintf(msg,
          "FRONT:%d cm LEFT:%d cm RIGHT:%d cm STATUS:WARNING LEFT\r\n",
          (int)front_dist,
          (int)left_dist,
          (int)right_dist);
      }
      ...
      else if(right_dist < 20)
      {
          ...
          sprintf(msg,
          "FRONT:%d cm LEFT:%d cm RIGHT:%d cm STATUS:WARNING RIGHT\r\n",
          (int)front_dist,
          (int)left_dist,
          (int)right_dist);
      }
      ...
      else
      {
          ...
          sprintf(msg,
          "FRONT:%d cm LEFT:%d cm RIGHT:%d cm STATUS:SAFE\r\n",
          (int)front_dist,
          (int)left_dist,
          (int)right_dist);
      }
