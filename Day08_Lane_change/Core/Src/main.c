...
/**
  ******************************************************************************
  * @file           : main.c
  * @brief          : Day8 Lane Change Assist System
  ******************************************************************************
  */
...
int main(void)
{
  ...
  while (1)
  {
      ...
      right_dist = read_distance(GPIOB,
                                 GPIO_PIN_12,
                                 GPIOB,
                                 GPIO_PIN_13);
      ...
      if(left_dist < 20 && right_dist < 20)
      {
          ...
          sprintf(msg,
          "LEFT:%d cm RIGHT:%d cm STATUS:BOTH BLOCKED\r\n",
          (int)left_dist,
          (int)right_dist);
      }
      ...
      else if(left_dist < 20)
      {
          ...
          sprintf(msg,
          "LEFT:%d cm RIGHT:%d cm STATUS:LEFT BLOCKED\r\n",
          (int)left_dist,
          (int)right_dist);
      }
      ...
      else if(right_dist < 20)
      {
          ...
          sprintf(msg,
          "LEFT:%d cm RIGHT:%d cm STATUS:RIGHT BLOCKED\r\n",
          (int)left_dist,
          (int)right_dist);
      }
      ...
      else
      {
          ...
          sprintf(msg,
          "LEFT:%d cm RIGHT:%d cm STATUS:SAFE LANE CHANGE\r\n",
          (int)left_dist,
          (int)right_dist);
      }
