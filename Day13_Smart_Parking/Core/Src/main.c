...
/**
  ******************************************************************************
  * @file           : main.c
  * @brief          : Day12 Driver Drowsiness Alert System
  ******************************************************************************
  */
...
int main(void)
{
  ...
  while (1)
  {
      ...
      if(front_dist > 50)
      {
          ...
          sprintf(msg,
          "DISTANCE:%d cm STATUS:SAFE PARKING\r\n",
          (int)front_dist);
      ...
      else if(front_dist > 30)
      {
          ...
          sprintf(msg,
          "DISTANCE:%d cm STATUS:SLOW WARNING\r\n",
          (int)front_dist);
      }
      ...
      else if(front_dist > 15)
      {
          ...
          sprintf(msg,
          "DISTANCE:%d cm STATUS:PARK CAREFULLY\r\n",
          (int)front_dist);
      }
      ...
      else
      {
          ...
          sprintf(msg,
          "DISTANCE:%d cm STATUS:STOP VEHICLE\r\n",
          (int)front_dist);
